...
public class Auteur2 implements Runnable{
	...
	public Auteur2(Socket s) throws IOException, NoSuchAlgorithmException, NoSuchProviderException {
		//Création connexion
		socket = s;
	...
	public void read() throws IOException, JSONException, NoSuchAlgorithmException {
		...
		case "letters_bag":
			...
			System.out.println("AUTEUR "+keyPublic.substring(keyPublic.length()-6, keyPublic.length())+"a recu sac de lettres  : "+letters_bag);
			break;
...
//			System.out.println(msg);
	...
	public JSONObject getLetter() throws JSONException, NoSuchAlgorithmException, UnsupportedEncodingException, InvalidKeyException, SignatureException {
		...
		System.out.println("AUTEUR "+keyPublic.substring(keyPublic.length()-6, keyPublic.length())+" inject letter "+ l);
		return lettre;
	}
	...
	public void listen() throws IOException, JSONException {
		...
		outchan.writeLong(taille);
		outchan.write(msg.getBytes("UTF-8"),0,(int)taille);
		System.out.println("AUTEUR "+keyPublic.substring(keyPublic.length()-6, keyPublic.length())+" sur écoute");
	...
	public void chooseWord(int period) throws JSONException, NoSuchAlgorithmException {
		if(map_wordPool.containsKey(period)) {
			...
			if(winner !=null) {
				...
				System.out.println("mot élu ("+score_max+" points) :"+ w.toString() );
